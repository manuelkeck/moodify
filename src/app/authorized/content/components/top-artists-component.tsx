...
function TopArtistComponent() {
    ...
    return (
        <div className="text-center">
            ...
            <p className="mt-20 mb-5 text-2xl font-extralight">Check out your top 10 tracks!</p>
            ...
            <p className="mt-20 mb-5 text-2xl font-extralight">Check out your top 10 artists!</p>
            <div className="flex flex-wrap justify-center">
