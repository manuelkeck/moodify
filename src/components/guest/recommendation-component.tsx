...
import MoodTransformationAttributes from "@/app/helper/mood-transformation-attributes";
...
const RecommendationComponent: React.FC<selectedMoodProps> = ({ selectedValue, carMode }) => {
    ...
    return (
        <div className="text-2xl font-extralight scroll-smooth overflow-y-scroll" ref={recommendationComponentRef}>
            ...
            <div className={`flex flex-wrap justify-center`}>
                <div className={`m-5 w-ful ${carMode ? "w-1/4 flex-row" : "sm:w-96 flex-col"}`}>
                    ...
                    {releaseButtons ? (
                        <>
                            <p className="mb-10">Listen to this created playlist!</p>
                            <div className="">
